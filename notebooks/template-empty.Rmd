...
# TODO: Import the package `purrr` for the purpose of 'iteration'
...
match_data <- map_dfr(
  # TODO: Map the constant `YEARS` onto the function `fetch_data`
  "___",
  ~fetch_data("England", DIVISION, .)
)
```
...
match_data <- match_data %>%
  # TODO: Select only the columns `home`, `away`, `hgoal`, and `agoal`
